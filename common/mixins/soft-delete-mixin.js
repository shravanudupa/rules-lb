...
const log = require('oe-logger')('audit-field-mixin');

log.info('Soft Delete Mixin is loaded');
module.exports = function SoftDeleteMixin(Model) {
  if (Model.modelName === 'BaseEntity') {
    return;
  }

  log.info(log.defaultContext(), 'Mixin is getting applied for %s model', Model.modelName);
